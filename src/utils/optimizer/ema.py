...
Codes copied from ema-pytorch==0.4.5.
To avoid of the situation where the original package is no longer available.

We thank the original author for the great work —— Copyright (c) 2022 Phil Wang
'''
